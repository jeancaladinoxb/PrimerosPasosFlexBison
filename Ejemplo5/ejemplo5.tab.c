...
#line 17 "ejemplo5.y"
                    { printf("= %d\n", yyvsp[-1]); }
#line 1074 "ejemplo5.tab.c"
    break;

  case 4: /* exp: factor  */
#line 20 "ejemplo5.y"
                  { yyval = yyvsp[0]; }
#line 1080 "ejemplo5.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 21 "ejemplo5.y"
                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1086 "ejemplo5.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 22 "ejemplo5.y"
                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1092 "ejemplo5.tab.c"
    break;

  case 7: /* factor: term  */
#line 25 "ejemplo5.y"
                   { yyval = yyvsp[0]; }
#line 1098 "ejemplo5.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 26 "ejemplo5.y"
                   { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1104 "ejemplo5.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 27 "ejemplo5.y"
                   { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1110 "ejemplo5.tab.c"
    break;

  case 10: /* term: NUMBER  */
#line 30 "ejemplo5.y"
             { yyval = yyvsp[0]; }
#line 1116 "ejemplo5.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 31 "ejemplo5.y"
             { yyval = yyvsp[0] >= 0? yyvsp[0] : - yyvsp[0]; }
#line 1122 "ejemplo5.tab.c"
    break;


#line 1126 "ejemplo5.tab.c"
